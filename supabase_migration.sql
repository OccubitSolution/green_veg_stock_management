...
--     delivery_slot TEXT DEFAULT 'morning', -- morning, evening, night
...
-- Purchases policies
DROP POLICY IF EXISTS "Vendors can view their own purchases" ON purchases;
...
DROP POLICY IF EXISTS "Vendors can create their own purchases" ON purchases;
...
DROP POLICY IF EXISTS "Vendors can update their own purchases" ON purchases;
CREATE POLICY "Vendors can update their own purchases"
  ON purchases FOR UPDATE
  USING (vendor_id = auth.uid());

-- Purchase items policies
DROP POLICY IF EXISTS "Vendors can view purchase items" ON purchase_items;
...
DROP POLICY IF EXISTS "Vendors can create purchase items" ON purchase_items;
...
DROP POLICY IF EXISTS "Vendors can view order status history" ON order_status_history;
...
DROP POLICY IF EXISTS "Vendors can create order status history" ON order_status_history;
...
DROP POLICY IF EXISTS "Vendors can view their delivery bundles" ON delivery_bundles;
...
DROP POLICY IF EXISTS "Vendors can create delivery bundles" ON delivery_bundles;
CREATE POLICY "Vendors can create delivery bundles"
  ON delivery_bundles FOR INSERT
  WITH CHECK (vendor_id = auth.uid());

DROP POLICY IF EXISTS "Vendors can update their delivery bundles" ON delivery_bundles;
...
-- Payments policies
DROP POLICY IF EXISTS "Vendors can view their payments" ON payments;
...
DROP POLICY IF EXISTS "Vendors can create payments" ON payments;
